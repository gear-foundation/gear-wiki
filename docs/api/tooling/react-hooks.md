...
For example, [this article](/examples/NFTs/nft-marketplace/nft-application.md) demonstrates the creation of a React application that connects to an [NFT smart contract](/examples/Standards/gnft-721.md) running on the blockchain.
