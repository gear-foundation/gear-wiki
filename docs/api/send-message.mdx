...
To send messages to the program:
...
In real conditions to ensure successful message processing, the calculation of the required gas for processing the message should be using `api.program.calculateGas` method.
...
To reply to a message from the program:
