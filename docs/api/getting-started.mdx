...
Also, refer to the [article](./../examples/nft-marketplace/nft-application) that demonstrates the creation of a TypeScript application that connects to an [NFT smart contract](./../examples/gnft-721) running on the blockchain.