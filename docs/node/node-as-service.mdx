...
You need to download or compile the gear-node executable file for your OS. [See more](/node/setting-up#install-with-pre-build-binary)
...
Note that once you delete the node, you will not be able to fully restore it. Refer to the [Backup and Restore](/node/backup-restore) article to know about the important data to be backed up.
