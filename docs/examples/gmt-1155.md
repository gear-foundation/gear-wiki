...
The default implementation of the NFT contract is provided in the gear library: [gear-contract-libarires/src/multioken](https://github.com/gear-tech/apps/tree/master/gear-contract-libraries/src/multitoken).

To use the default implementation you should include the packages into your Cargo.toml file:
```toml
gear-contract-libraries = { path = ".https://github.com/gear-tech/apps/tree/master/gear-contract-libraries" }
derive_traits = { path = "https://github.com/gear-tech/apps/tree/master/gear-contract-libraries/utils/derive_traits" }
```
