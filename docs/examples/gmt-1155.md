...
The default implementation of the NFT contract is provided in the Gear library: [gear-lib/multitoken](https://github.com/gear-academy/gear-lib/tree/master/src/multitoken).

To use the default implementation you should include the packages into your Cargo.toml file:
```toml
gear-contract-libraries = { path = ".https://github.com/gear-academy/gear-lib" }
derive_traits = { path = "https://github.com/gear-academy/gear-lib/tree/master/derive" }
```
...
A source code of the base lib providing multitoken functionality provided by Gear is available on GithHub: [`gear-lib/src/multitoken`](https://github.com/gear-academy/gear-lib/tree/master/src/multitoken).

A source code of the contract example provided by Gear is available on GitHub: [`multitoken/src`](https://github.com/gear-academy/multitoken/tree/master/src).

See also an example of the smart contract testing implementation based on gtest: [`multitoken/tests`](https://github.com/gear-academy/multitoken/tree/master/tests).
