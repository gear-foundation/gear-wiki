...
https://github.com/gear-foundation/dapps-app/blob/master/Cargo.toml#L10
...
The source code of the image is available on [GitHub](https://github.com/gear-foundation/dapps-gear-env).
...
```bash
docker pull ghcr.io/gear-foundation/dapps-gear-env:stable
```
...
```bash
docker run --rm --name gear-env -itd ghcr.io/gear-foundation/dapps-gear-env:stable bash
```
</TabItem>
...
```bash
docker run --rm --name gear-env --platform linux/amd64 -itd ghcr.io/gear-foundation/dapps-gear-env:stable bash
```
</TabItem>
</Tabs>
````
